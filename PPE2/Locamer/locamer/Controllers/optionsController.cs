...
namespace locamer.Controllers
{
    public class optionsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "libelle,prix_jour,id_loc")] option option)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "libelle,prix_jour,id_loc")] option option)
        {
            if (ModelState.IsValid)
            {
